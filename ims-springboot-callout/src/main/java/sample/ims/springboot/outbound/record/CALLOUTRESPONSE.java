...
/**
 * @generated
 * Generated Class: CALLOUTRESPONSE
...
public class CALLOUTRESPONSE implements javax.resource.cci.Record,
		javax.resource.cci.Streamable, com.ibm.etools.marshall.RecordBytes {
	private static final long serialVersionUID = -4860916811896691852L;
	/**
	 * @generated
	 */
	...
	static {
		...
		String calloutresponsestrInitialValue = " ";
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
				calloutresponsestrInitialValue, initializedBuffer_, 0,
	 ...
	 * @generated
	 */
	public CALLOUTRESPONSE(java.util.HashMap valFieldNameMap) {
	 ...
	 */
	public String getCalloutresponsestr() {
		String calloutresponsestr = null;
		calloutresponsestr = MarshallStringUtils
				.unmarshallFixedLengthStringFromBuffer(buffer_, 0, "IBM-1047",
						40);
		return (calloutresponsestr);
	}

	/**
	 * @generated
	 */
	public void setCalloutresponsestr(String calloutresponsestr) {
		if (calloutresponsestr != null) {
			if (calloutresponsestr.length() > 40)
				throw new IllegalArgumentException(MarshallResource.instance()
						.getString(MarshallResource.IWAA0124E,
								calloutresponsestr, "40", "calloutresponsestr"));
			MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
					calloutresponsestr, buffer_, 0, "IBM-1047", 40,
